<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="AddActivity.aspx.cs" Inherits="enGage.Web.AddActivity" %>
    ...
    <div class="page">
        ...
        <table id="tblActivity" runat="server" class="page-table" style="width: 100%;">
            ...
            <tr>
                ...
                <td width="200px">
                    Status:&nbsp;&nbsp;
                    <asp:DropDownList ID="ddlOpportunityStatus" runat="server" OnSelectedIndexChanged="ddlOpportunityStatus_SelectedIndexChanged"
                ...
                <td width="180px">
                    Follow-up:
                    <asp:TextBox ID="txtFollowUpDate" runat="server" Width="72px" 
            ...
            <tr id="trLost1" visible="false">
                ...
                <td colspan="2">
                    <asp:TextBox ID="txtDateCompleted" runat="server" MaxLength="10" Width="72px" 
                        CssClass="control" ToolTip="dd/mm/yyyy"></asp:TextBox>
