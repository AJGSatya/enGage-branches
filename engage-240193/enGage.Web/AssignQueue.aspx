<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AssignQueue.aspx.cs" Inherits="enGage.Web.AssignQueue" %>
...
//            });
        ...
        function setUpPage() {
            ...
            $("#<%=btnassignSelectedOpportunities.ClientID%>").attr("disabled", true).css("cursor", "default").fadeTo(500, 0.5) ;
            $("#<%=ddlExecutive.ClientID%>").bind('change', function(e) {
                setButtonEnable();
            });
        ...
        function setButtonEnable() {
            ...
            if ($("#<%=selectedOpportunitiesIDs.ClientID%>")[0].value.replace(regex, "") != "" && $("#<%=ddlExecutive.ClientID%>")[0].selectedIndex !== 0)
                $("#<%=btnassignSelectedOpportunities.ClientID%>").removeAttr("disabled").css("cursor", "pointer").fadeTo(500,1);
            else
                $("#<%=btnassignSelectedOpportunities.ClientID%>").attr("disabled", true).css("cursor", "default").fadeTo(500,0.5);
    ...
    <td colspan="2">
        ...
        <tr>
            <td class="page-group" colspan="2" style="font-weight:bold">
                <asp:Label ID="Label1" runat="server">Assign To</asp:Label>
            </td>
        </tr>
                        ...
                        <td colspan="2">
                            <asp:UpdatePanel ID="udpLevel" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <asp:Button ID="btnassignSelectedOpportunities" runat="server" 
                                Text="Assign selected Opprtunities" style="float:right"
                    CssClass="button-link" onclick="btnassignSelectedOpportunities_Click"  />
                               ...
                               <asp:AsyncPostBackTrigger ControlID="ddlExecutive" EventName="SelectedIndexChanged" />
                                <asp:PostBackTrigger ControlID="btnassignSelectedOpportunities" />
                                </Triggers>
                            </asp:UpdatePanel>
        ...
        <tr>
            <td class="page-group" colspan="2" style="font-weight:bold">
                <asp:Label ID="lblSummary" runat="server">Current Activities</asp:Label>
            </td>
        </tr>
         <tr>
