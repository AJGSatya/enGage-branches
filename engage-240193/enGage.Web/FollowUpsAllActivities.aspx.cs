...
{
    public partial class FollowUpsAllActivities : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                using (Timeline.Capture("FollowUpsAllActivities.aspx", "ASP.NET"))
                {
                    if (!this.IsPostBack)
                    {
        ...
        protected void lnkSeeAllSuspects_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("FollowUpsAll.aspx?f1=" + this.ddlOAMPSIncome.SelectedValue 
                                ...
                                + "&l1=" + HttpUtility.UrlEncode(ddlRegion.SelectedValue)
